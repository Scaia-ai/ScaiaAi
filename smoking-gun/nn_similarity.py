...
def train_nn(embeddings_file_path = os.path.join("input_data", "email_embeddings.csv"), distance_type="cosine", file_prefix=""):
...
def test_nn(embeddings_file_path = os.path.join("input_data", "email_embeddings.csv"), distance_type="cosine", file_prefix=""):
...
if __name__ == "__main__":
    ...
    embeddings_file_path = os.path.join("input_data", "email_embeddings.csv")
