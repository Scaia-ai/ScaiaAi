...
def get_doc_representations(input_email_text_file = os.path.join("input_data", "mueller_paragraphs.csv"),
                            output_embedding_file = os.path.join("input_data", "paragraph_embeddings.csv")):
