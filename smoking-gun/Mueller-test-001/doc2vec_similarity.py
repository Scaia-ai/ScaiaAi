...
def train_doc2vec(model_file_name = os.path.join("input_data", "doc2vec_model.bin"), embeddings_file_path = os.path.join("input_data", "mueller_embeddings.csv")):
...
def test_doc2vec(embeddings_file_path = os.path.join("input_data", "mueller_embeddings.csv"),
...
if __name__ == "__main__":
    ...
    single_doc = "Collusion with Russia "
