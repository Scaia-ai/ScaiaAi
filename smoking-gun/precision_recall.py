...
def p_r_f1_scores(jacc_results_path       = os.path.join("output_data", "bert_testing_jaccard.csv"),
    ...
    for model_name, file_path in [("bert_jaccard", jacc_results_path), ("bert_cosine", cos_results_path), ("doc2vec", doc2vec_results_path)]:
...
if __name__ == "__main__":
    ...
    jacc_results_path = os.path.join("output_data", "bert_testing_jaccard.csv")
    cos_results_path = os.path.join("output_data", "bert_testing_cosine.csv")
    doc2vec_results_path = os.path.join("output_data", "doc2vec_testing.csv")
