...
def download_enron_data(download_to_folder = os.path.join("input_data", "emails")):
    ...
    assert os.path.exists(download_to_folder), "Folder name 'input_data' or subfolder 'emails' do not exist. Please create empty folders with these names & rerun again"
...
if __name__ == "__main__":
    ...
    download_enron_data(download_to_folder = os.path.join("input_data", "results"))
