...
def train_nn(embeddings_file_path = os.path.join("input_data", "enron_embeddings.csv"), distance_type="cosine", file_prefix=""):
...
def test_nn(embeddings_file_path = os.path.join("input_data", "enron_embeddings.csv"), distance_type="cosine", file_prefix=""):
