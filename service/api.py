...
users_filename = 'users.pickle'
projects_filename = 'project.pickle'
uris_filename = 'uris.pickle'
...
def pickle_files():
    ...
    outfile = open(projects_filename, 'wb')
    pickle.dump(projects, outfile)
    outfile.close()

    outfile = open(uris_filename, 'wb')
    pickle.dump(uris, outfile)
    outfile.close()
